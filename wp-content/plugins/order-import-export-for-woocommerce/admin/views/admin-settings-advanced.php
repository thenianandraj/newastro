...
<div class="wt-iew-tab-content" data-id="<?php echo esc_attr($target_id);?>">
	<?php
	$fields=Wt_Import_Export_For_Woo_Order_Basic_Common_Helper::get_advanced_settings_fields();
	...
	<table class="form-table wt-iew-form-table">
		<?php
		Wt_Import_Export_For_Woo_Order_Basic_Common_Helper::field_generator($fields, $advanced_settings);
		?>
	</table>
    <?php 
