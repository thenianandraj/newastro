...
$plugins=array(
    ...
    'request_quote' => array(
        ...
        'description'   => __('Set up a WooCommerce quote request system that lets customers request custom pricing. Hide product prices, replace "Add to Cart" with an "Add to quote" button, accept pricing requests, and manage all quotes directly from your store.', 'order-import-export-for-woocommerce'),
    ...
    'giftcards_plugin' => array(
        ...
        'description'   => __('Create and sell customizable digital and physical gift cards in your WooCommerce store. Allow customers to send, schedule, and redeem gift vouchers while you manage store credits and boost sales using flexible gift card options and templates.', 'order-import-export-for-woocommerce'),
    ...
    'smart_coupons_plugin' => array(
        ...
        'description'   => __('Create and manage advanced WooCommerce coupons and discounts for your customers. Set up high-converting campaigns like BOGO deals, store credits, gift vouchers, auto-apply and condition-based coupons, and bulk-generate coupon codes to increase sales and customer engagement.', 'order-import-export-for-woocommerce'),
    ...
    'url_coupons_plugin' => array(
        ...
        'description'   => __('Generate custom URLs and QR codes for your WooCommerce coupons that are easy to share and automatically apply discounts when clicked. These unique coupon URLs are easy to share and can even be set to add new products to the cart upon clicking.', 'order-import-export-for-woocommerce'),
    ...
    'sequential_order_plugin' => array(
        ...
        'description' => __('Make your WooCommerce order numbers look clean and professional with sequential order numbers. This plugin creates sequential WooCommerce order numbers and lets you set custom order numbers with prefixes, suffixes, and increments, making orders easier to track and manage.', 'order-import-export-for-woocommerce'),
	...
	'wt_ipc_addon' => array(
        ...
        'description'   => __('Automatically generate and send professional PDF invoices, packing slips, and credit notes for every WooCommerce order. Customize document templates, include tax details, and allow customers to easily download or print order documents.', 'order-import-export-for-woocommerce'),
    ...
    'wt_sdd_addon' => array(
        ...
        'description'   => __('Create and print shipping labels, delivery notes, and dispatch documents from your WooCommerce store. Customize document layouts and include order details to make packing and shipping easier and faster.', 'order-import-export-for-woocommerce'),
    ...
    'wt_pi_addon' => array(
        ...
        'description'   => __('Automatically create and send professional proforma invoices for WooCommerce orders. Customize invoice templates, numbers, and details, attach PDFs to order emails, and let customers download or print them easily for pre-payment clarity.', 'order-import-export-for-woocommerce'),
    ...
    'wt_al_addon' => array(
        ...
        'description'   => __('Generate address labels for your WooCommerce orders and print them in bulk to make packing and shipping faster and more accurate. Customize label layouts and easily generate labels of different types (shipping, billing, return, and from address) with ease.', 'order-import-export-for-woocommerce'),
    ...
    'product_recommendations' => array(
        ...
        'description'   => __('Show personalized product recommendations with 10+ popular recommendations templates. Recommend upsells, cross-sells, best-sellers, frequently bought together, and more to increase the average order value and improve the shopping experience.', 'order-import-export-for-woocommerce'),
