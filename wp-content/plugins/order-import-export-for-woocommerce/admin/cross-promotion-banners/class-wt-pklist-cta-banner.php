		...
		public function add_meta_box() {
			if ( ! defined( 'WT_PDF_INVOICE_PLUGIN_DISPLAY_BANNER' ) ) {
				add_meta_box(
					...
					self::$is_bfcm_season ? ' ' : __( 'WooCommerce PDF Invoices, Packing Slips and Credit Notes', 'order-import-export-for-woocommerce' ),
				...
				<div class="wbte-cta-content">
                    ...
                    if ( self::$is_bfcm_season ) {
                        ...
                        <div class="wbte-cta-banner-features_head_div">
                            <img src="<?php echo esc_url( $wt_admin_img_path . '/pdf_invoice.svg' ); ?>" alt="<?php esc_attr_e( 'upgrade box icon', 'order-import-export-for-woocommerce' ); ?>">
                            <h2><?php esc_html_e( 'WooCommerce PDF Invoices, Packing Slips and Credit Notes', 'order-import-export-for-woocommerce' ); ?></h2>
                        </div>
                        <?php
                    }
                    ?>
					...
					<ul class="wbte-cta-features">
						<li><?php esc_html_e( 'Automatically generate PDF invoices, packing slips, and credit notes', 'order-import-export-for-woocommerce' ); ?></li>
						<li><?php esc_html_e( 'Use ready-made, customizable templates to match your brand', 'order-import-export-for-woocommerce' ); ?></li>
						<li><?php esc_html_e( 'Print or download invoices individually or in bulk', 'order-import-export-for-woocommerce' ); ?></li>
						<li><?php esc_html_e( 'Set custom invoice numbering for better organization', 'order-import-export-for-woocommerce' ); ?></li>
						<li class="hidden-feature"><?php esc_html_e( 'Customize documents fully with visual or code editors', 'order-import-export-for-woocommerce' ); ?></li>
						<li class="hidden-feature"><?php esc_html_e( 'Include VAT, GST, ABN, and other tax details', 'order-import-export-for-woocommerce' ); ?></li>
						<li class="hidden-feature"><?php esc_html_e( 'Add "Pay Now" link on invoices', 'order-import-export-for-woocommerce' ); ?></li>
						<li class="hidden-feature"><?php esc_html_e( 'Add custom fields to any order document with ease', 'order-import-export-for-woocommerce' ); ?></li>
					</ul>
