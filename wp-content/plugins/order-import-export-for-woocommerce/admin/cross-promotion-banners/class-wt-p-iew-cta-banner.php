		...
		public function add_meta_box() {
			...
			if ( ! defined( 'WT_PRODUCT_IMPORT_EXPORT_DISPLAY_BANNER' ) && $total_products >= 50 ) {
				add_meta_box(
					...
					self::$is_bfcm_season ? ' ' : __( 'Product Import Export for WooCommerce', 'order-import-export-for-woocommerce' ),
				...
				<div class="wbte-cta-content">
                    ...
                    if ( self::$is_bfcm_season ) {
                        ...
                        <div class="wbte-cta-banner-features_head_div">
                            <img src="<?php echo esc_url( $wt_admin_img_path . '/product-ie.svg' ); ?>" alt="<?php esc_attr_e( 'upgrade box icon', 'order-import-export-for-woocommerce' ); ?>">
                            <h2><?php esc_html_e( 'Product Import Export for WooCommerce', 'order-import-export-for-woocommerce' ); ?></h2>
                        </div>
                        <?php
                    }
                    ?>
					...
					<ul class="wbte-cta-features">
						<li><?php esc_html_e( 'Import, export, or update WooCommerce products', 'order-import-export-for-woocommerce' ); ?></li>
						<li><?php esc_html_e( 'Supports all types of products (Simple, variable, subscription grouped, and external)', 'order-import-export-for-woocommerce' ); ?></li>
						<li><?php esc_html_e( 'Multiple file formats - CSV, XML, Excel, and TSV', 'order-import-export-for-woocommerce' ); ?></li>
						<li><?php esc_html_e( 'Advanced filters and customizations for better control', 'order-import-export-for-woocommerce' ); ?></li>
						<li class="hidden-feature"><?php esc_html_e( 'Bulk update WooCommerce product data', 'order-import-export-for-woocommerce' ); ?></li>
						<li class="hidden-feature"><?php esc_html_e( 'Import via FTP/SFTP and URL', 'order-import-export-for-woocommerce' ); ?></li>
						<li class="hidden-feature"><?php esc_html_e( 'Schedule automated import & export', 'order-import-export-for-woocommerce' ); ?></li>
						<li class="hidden-feature"><?php esc_html_e( 'Export and Import custom fields and third-party plugin fields', 'order-import-export-for-woocommerce' ); ?></li>
					</ul>
