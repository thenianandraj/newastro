				...
				if($field_html=='')
				{
					...
					elseif($type=='multi_select')
					{
	                    			...
	                    			?>
	                  				<option value="<?php echo esc_attr($single_vl);?>" selected><?php echo sprintf(
                                               /* translators: $1: user name, $2 user id, $3: user email */
                                                esc_html__( '%1$s (#%2$s &ndash; %3$s)', 'order-import-export-for-woocommerce'),
                        ...
                        if(in_array('wt-coupon-search', $css_class_arr)){
	                    	...
	                    	{
                    			?>
                  				<option value="<?php echo esc_attr($single_vl);?>" selected><?php echo esc_html($single_vl);?></option>
                    			<?php
	                    	}
	                    }
					...
					}elseif($type=='uploader')
					{
						...
						<div class="wt_iew_file_attacher_dv">
							...
							<input type="button" name="upload_file" data-wt_iew_file_attacher_title="<?php esc_html_e('Choose a file.', 'order-import-export-for-woocommerce'); ?>"  data-wt_iew_file_attacher_button_text="<?php esc_html_e('Select', 'order-import-export-for-woocommerce'); ?>" class="wf_button button button-primary wt_iew_file_attacher" wt_iew_file_attacher_target="#<?php echo esc_attr($field_id); ?>" value="<?php esc_html_e('Upload', 'order-import-export-for-woocommerce'); ?>" />
						</div>
						<?php
					}elseif($type=='dropzone') /* dropzone file uploader */
					{
						...
						<div id="<?php echo esc_attr($dropzone_id);?>" class="wt_iew_dropzone" wt_iew_dropzone_target="#<?php echo esc_attr($field_id); ?>">
							<div class="dz-message">
								<?php esc_html_e('Drag and Drop', 'order-import-export-for-woocommerce'); ?>
								<?php esc_html_e('or', 'order-import-export-for-woocommerce'); ?>
								<?php esc_html_e(' Click and Upload', 'order-import-export-for-woocommerce');?>
