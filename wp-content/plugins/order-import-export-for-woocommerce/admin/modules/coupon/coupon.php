...
if(!class_exists('Wt_Import_Export_For_Woo_Order_Basic_Coupon')){
class Wt_Import_Export_For_Woo_Order_Basic_Coupon {
    ...
    public function process_coupons_bulk_actions() {
        ...
        if ($typenow == 'shop_coupon') {
            ...
            if ($action == 'wt_ier_download_coupons') {
                ...
                Wt_Import_Export_For_Woo_Order_Basic_Coupon_Bulk_Export::do_export('shop_coupon', $coupon_ids);
            }
        }
    }
    /**
    ...
    */
    ...
    public function importer_do_import($import_data, $base, $step, $form_data, $selected_template_data, $method_import, $batch_offset, $is_last_batch) {        
        ...
        $import = new Wt_Import_Export_For_Woo_Order_Basic_Coupon_Import($this);
    ...
    public function exporter_do_export($export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset) {
        ...
        $export = new Wt_Import_Export_For_Woo_Order_Basic_Coupon_Export($this);
...
new Wt_Import_Export_For_Woo_Order_Basic_Coupon();
