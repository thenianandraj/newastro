...
if(!class_exists('Wt_Import_Export_For_Woo_Order_Basic_Order_Import')){
class Wt_Import_Export_For_Woo_Order_Basic_Order_Import {
            ...
            foreach ( $parts as $part ) {
                ...
                switch ($key) {
                    ...
                    case 'taxes':
                        ...
                        $tax_data = Wt_Import_Export_For_Woo_Order_Basic_Common_Helper::wt_unserialize_safe($raw);
