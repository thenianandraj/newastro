...
if(!class_exists('Wt_Iew_IE_Basic_Helper'))
{
	...
	class Wt_Iew_IE_Basic_Helper
	{
		...
		{
			return array(
				'comma'=>array('value'=>__('Comma', 'order-import-export-for-woocommerce'), 'val'=>","),
				'semicolon'=>array('value'=>__('Semicolon', 'order-import-export-for-woocommerce'), 'val'=>";"),
				'tab'=>array('value'=>__('Tab', 'order-import-export-for-woocommerce'), 'val'=>"\t"),
				'space'=>array('value'=>__('Space', 'order-import-export-for-woocommerce'), 'val'=>" "),
				'other'=>array('value'=>__('Other', 'order-import-export-for-woocommerce'), 'val'=>""),
			);
		}
		...
		public static function get_validation_rules($step, $form_data, $module_obj)
		{
			...
			if(method_exists($module_obj, $method_name))
			{
				...
				$out=Wt_Import_Export_For_Woo_Order_Basic_Common_Helper::extract_validation_rules($fields);
			}
		...
		public static function debug_panel($module_base)
		{
			if($module_base=='import' || $module_base=='export')
			{
				$debug_panel_btns=array(
					'refresh_step'=>array(
						'title'=>__('Refresh the step', 'order-import-export-for-woocommerce'),
						'icon'=>'dashicons dashicons-update',
						'onclick'=>'wt_iew_basic_'.$module_base.'.refresh_step();',
					),
					'console_form_data'=>array(
						'title'=>__('Console form data', 'order-import-export-for-woocommerce'),
			...
			{
				?>
				<div class="wt_iew_debug_panel" title="<?php esc_html_e('For debugging process', 'order-import-export-for-woocommerce');?>">
					<div class="wt_iew_debug_panel_hd"><?php esc_html_e('Debug panel', 'order-import-export-for-woocommerce');?></div>
					<div class="wt_iew_debug_panel_con">
						<?php
						foreach ($debug_panel_btns as $btn) 
						{
							?>
							<a onclick="<?php echo esc_js($btn['onclick']);?>" title="<?php echo esc_attr($btn['title']);?>">
