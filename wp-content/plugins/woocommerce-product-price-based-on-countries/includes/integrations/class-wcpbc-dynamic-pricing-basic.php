...
class WCPBC_Dynamic_Pricing_Basic {
	...
	public static function simple_membership() {
		if ( is_callable( array( 'WC_Dynamic_Pricing_Simple_Membership', 'instance' ) ) && isset( WC_Dynamic_Pricing_Simple_Membership::instance()->available_rulesets ) ) {
	...
	public static function simple_category() {
		if ( ! is_callable( array( 'WC_Dynamic_Pricing_Simple_Category', 'instance' ) ) ) {
			return;
		}
	...
	public static function advanced_category() {
		if ( ! ( is_callable( array( 'WC_Dynamic_Pricing_Advanced_Category', 'instance' ) ) && isset( WC_Dynamic_Pricing_Advanced_Category::instance()->adjustment_sets ) && is_array( WC_Dynamic_Pricing_Advanced_Category::instance()->adjustment_sets ) ) ) {
			return;
		}
