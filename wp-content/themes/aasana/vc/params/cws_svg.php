...
function cws_vc_svg ( $settings, $value ){
	...
	$output .= "<a href='#' class='cws_svg_icon' style='" . (!empty($value) ? "display:none;" : "") . "'>Add</a>";
	$output .= "<a href='#' class='cws_svg_icon_remove' style='color: red; " . (empty($value) ? "display:none;" : "") . "'>Remove</a>";
	$output .= $svg_content;
	$output .= "</div>";
	return $output;
}
